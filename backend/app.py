...
def _fetch_civitai_style_presets(query, limit):
    ...
    API 文档: https://github.com/civitai/civitai/wiki/REST-API-Reference
    - prompt 在 items[].meta.prompt，不在顶层
    ...
    try:
        ...
        # 文档: limit, nsfw(None/Soft/Mature/X), sort(Most Reactions, Most Comments, Newest), period, page
        # 无 query 参数，仅用 limit/sort/nsfw
        params = {
            "limit": min(limit, 100),
            "sort": "Newest",
        }
